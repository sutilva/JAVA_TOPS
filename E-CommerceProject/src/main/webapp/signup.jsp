		...
		<form name="registrationForm" action="register.jsp"  method="get" onsubmit="return validateForm()">
			<div class="form-group input-group">
				...
				<input name="fullname" class="form-control" placeholder="Full name"
					type="text" id="fullname" pattern="^[a-zA-Z\s]+$" title="Full name should only contain letters and spaces.">
			</div>
			<!-- form-group// -->
			<div class="form-group input-group">
				<div class="input-group-prepend">
			...
			<div class="form-group input-group">
				...
				<select class="custom-select" style="max-width: 120px;">
					...
					placeholder="Phone number" type="text" id="phone" pattern="^[0-9]{10}$" title="Phone number should be 10 digits.">
			</div>
			<!-- form-group// -->
			<!-- <div class="form-group input-group">
    	<div class="input-group-prepend">
		...
		<select class="form-control">
			...
			<div class="form-group input-group">
				...
				<input class="form-control" placeholder="Create password"
					type="password" name="password" id="password" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[!@#$%^&*]).{8,}$" required title="Password must be at least 8 characters long, contain at least 1 uppercase letter, 1 lowercase letter, 1 special character, and 1 digit.">
			</div>
			<!-- form-group// -->
			<div class="form-group input-group">
				<div class="input-group-prepend">
