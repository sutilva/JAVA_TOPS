...
class Calculator_app extends WindowAdapter implements ActionListener { 
...
Calculator_app(){ 
	...
	frame.add(l1);  
	frame.add(b1); frame.add(b2); frame.add(b3); frame.add(b4); frame.add(b5); frame.add(b6); frame.add(b7); frame.add(b8); frame.add(b9); frame.add(b0);
	
	frame.add(badd); frame.add(bsub); frame.add(bmod); frame.add(bmult); frame.add(bdiv); frame.add(bmod); frame.add(bcalc);
